...
function App(props) {
  ...
  //countdown div is a simple div that shows the countdown time and disappears after timeout
  const maindiv = useRef(null)
  //maindiv is a simple dive
  ...
  return (
    <div>
      ...
      <div ref={maindiv}>
        ...
        <div ref={wordsdiv} className="wordsdivv" onKeyDown={e => { console.log(e) }}>
          {wordsRef.current}
        </div>
