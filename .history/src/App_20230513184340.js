...
function App(props) {
  ...
  // useEffect(()=>{
  //   spandiv.addEventListener("input", ()=>{
  //     console.log('bc whatot')
  //   })
  // },[])
  ...
  function beginTyping(i) {
    if (boolstart) {
      if (typed === wordsRef.current[i]) {
        ...
        wordsRef.current[i].style = "green"
        console.log(wordsRef.current[i].style="green") 
        //figure out why null used
        //green
        // wordsRef.current[i].style.color="green"
