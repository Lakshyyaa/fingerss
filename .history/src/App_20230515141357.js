...
import React, { useState, useEffect, useRef, useContext, useDebugValue, useCallback, useLayoutEffect } from "react";
import UserName from "./userName";
import userEvent from "@testing-library/user-event";
import { type } from "@testing-library/user-event/dist/type";
function App(props) {
  ...
  return (
    <div>
      ...
      <div ref={maindiv}>
        ...
        <button onClick={() => countdown()} disabled={boolStart}>Start</button>
        {/* above button calls countdown and is disabled */}
        <h1>WPM: {wordspm}</h1>
        <h1>Accuracy: {accuracy}%</h1>
      </div>
